...
public class Queen extends Piece{
    ...
    private static boolean isFirstColumnExclusion(final int currentPosition, final int candidateCoordinateOffset) {
        return BoardUtils.FIRST_COLUMN[currentPosition] && (candidateCoordinateOffset == -9 || candidateCoordinateOffset == 7
                || candidateCoordinateOffset == -1);
    }

    private static boolean isEighthColumnExclusion(final int currentPosition, final int candidateCoordinateOffset) {
